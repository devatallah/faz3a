!function (a, b) {
    ...
    var c = (function (a) {
        ...
        function b() {
            return {
                bindType: e.end, delegateType: e.end, handle: function (b) {
        ...
        function c() {
            ...
            for (var b in f) if (void 0 !== a.style[b]) return {end: f[b]};
            return !1
        }
        ...
        return function () {
            e = c(), a.fn.emulateTransitionEnd = d, g.supportsTransitionEnd() && (a.event.special[g.TRANSITION_END] = b())
        }(), g
    }(jQuery);
    !function (a) {
        var e = "metisMenu", f = a.fn[e], g = {
            toggle: !0,
            preventDefault: !0,
            activeClass: "active",
            ...
            function e(a, c) {
                b(this, e), this._element = a, this._config = this._getConfig(c), this._transitioning = null, this.init()
            }

            return e.prototype.init = function () {
                var b = this;
                a(this._element).find(this._config.parentTrigger + "." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !0).addClass(this._config.collapseClass + " " + this._config.collapseInClass), a(this._element).find(this._config.parentTrigger).not("." + this._config.activeClass).has(this._config.subMenu).children(this._config.subMenu).attr("aria-expanded", !1).addClass(this._config.collapseClass), a(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(h.CLICK_DATA_API, function (c) {
                ...
                if (!this._transitioning && !a(b).hasClass(this._config.collapsingClass)) {
                    var c = this, e = a(b), f = a.Event(h.SHOW);
                    if (e.trigger(f), !f.isDefaultPrevented()) {
                        ...
                        var g = function () {
                            e.removeClass(c._config.collapsingClass).addClass(c._config.collapseClass + " " + c._config.collapseInClass).height("").attr("aria-expanded", !0), c.setTransitioning(!1), e.trigger(h.SHOWN)
                        };
                        if (!d.supportsTransitionEnd()) return void g();
                        e.height(e[0].scrollHeight).one(d.TRANSITION_END, g).emulateTransitionEnd(350)
                    }
                }
            }, e.prototype._hide = function (b) {
                if (!this._transitioning && a(b).hasClass(this._config.collapseInClass)) {
                    var c = this, e = a(b), f = a.Event(h.HIDE);
                    if (e.trigger(f), !f.isDefaultPrevented()) {
                        e.parent(this._config.parentTrigger).removeClass(this._config.activeClass), e.height(e.height())[0].offsetHeight, e.addClass(this._config.collapsingClass).removeClass(this._config.collapseClass).removeClass(this._config.collapseInClass), this.setTransitioning(!0);
                        var g = function () {
                            c._transitioning && c._config.onTransitionEnd && c._config.onTransitionEnd(), c.setTransitioning(!1), e.trigger(h.HIDDEN), e.removeClass(c._config.collapsingClass).addClass(c._config.collapseClass).attr("aria-expanded", !1)
                        };
                        if (!d.supportsTransitionEnd()) return void g();
                        0 == e.height() || "none" == e.css("display") ? g() : e.height(0).one(d.TRANSITION_END, g).emulateTransitionEnd(350)
                    }
                }
            }, e.prototype.setTransitioning = function (a) {
                this._transitioning = a
            }, e.prototype.dispose = function () {
                a.removeData(this._element, "metisMenu"), a(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).off("click"), this._transitioning = null, this._config = null, this._element = null
            }, e.prototype._getConfig = function (b) {
                return b = a.extend({}, g, b)
            }, e._jQueryInterface = function (b) {
                return this.each(function () {
                    var d = a(this), f = d.data("metisMenu"),
                        h = a.extend({}, g, d.data(), "object" === (void 0 === b ? "undefined" : c(b)) && b);
                    if (!f && /dispose/.test(b) && this.dispose(), f || (f = new e(this, h), d.data("metisMenu", f)), "string" == typeof b) {
        ...
        a.fn[e] = i._jQueryInterface, a.fn[e].Constructor = i, a.fn[e].noConflict = function () {
    ...
    jQuery.fn.extend({
        slimScroll: function (b) {
            ...
            return this.each(function () {
                ...
                function f() {
                    n = Math.max(s.outerHeight() / s[0].scrollHeight * s.outerHeight(), q), v.css({height: n + "px"});
                    var a = n == s.outerHeight() ? "none" : "block";
                    v.css({display: a})
                }

                function g() {
                    f(), clearTimeout(l), o == ~~o ? (r = c.allowPageScroll, p != o && s.trigger("slimscroll", 0 == ~~o ? "top" : "bottom")) : r = !1, p = o, n >= s.outerHeight() ? r = !0 : (v.stop(!0, !0).fadeIn("fast"), c.railVisible && w.stop(!0, !0).fadeIn("fast"))
                }

                function h() {
                    c.alwaysVisible || (l = setTimeout(function () {
                        c.disableFadeOut && i || j || k || (v.fadeOut("slow"), w.fadeOut("slow"))
                    }, 1e3))
                }

                var i, j, k, l, m, n, o, p, q = 30, r = !1, s = a(this);
                if (s.parent().hasClass(c.wrapperClass)) {
                    ...
                    w.css(x), v.css(x), s.wrap(u), s.parent().append(v), s.parent().append(w), c.railDraggable && v.bind("mousedown", function (b) {
                        var c = a(document);
                        return k = !0, t = parseFloat(v.css("top")), pageY = b.pageY, c.bind("mousemove.slimscroll", function (a) {
                        ...
                        r || a.originalEvent.preventDefault(), a.originalEvent.touches.length && (e((m - a.originalEvent.touches[0].pageY) / c.touchScrollStep, !0), m = a.originalEvent.touches[0].pageY)
                    }), f(), "bottom" === c.start ? (v.css({top: s.outerHeight() - v.outerHeight()}), e(0, !0)) : "top" !== c.start && (e(a(c.start).position().top, null, !0), c.alwaysVisible || v.hide()), function () {
    ...
    b.defaults = {
        ...
        var c = this.$element, d = c.parent(), e = this.$back_text, f = this.$front_text, g = this.options,
            h = parseInt(c.attr("data-transitiongoal")), i = parseInt(c.attr("aria-valuemin")) || 0,
            j = parseInt(c.attr("aria-valuemax")) || 100, k = d.hasClass("vertical"),
    ...
    a.fn.progressbar = function (c) {
        return this.each(function () {
            ...
            e && f && a.extend(e.options, f), e || d.data("bs.progressbar", e = new b(this, f)), e.transition()
        })
    ...
    !function (a) {
        ...
        "use strict";
        var d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H, I = {}, J = 0;
        d = function () {
            return {
                common: {
                    type: "line",
            ...
            init: function (a, b) {
                ...
                var b, d, e = this.splist, f = e.length, g = !1;
                ...
                var a, b, d, e, f, g = this.splist, h = g.length, i = !1, j = this.$canvas.offset(),
            ...
            init: function (b) {
                var d, e = b.get("tooltipClassname", "jqstooltip"), f = this.sizeStyle;
            ...
            return this.each(function () {
                var e, f, g = new c.fn.sparkline.options(this, d), h = c(this);
                if (e = function () {
                    var d, e, f, i, j, k, l;
                    ...
                    if (!g.get("composite") && c.data(this, "_jqs_pending")) for (f = H.length; f; f--) H[f - 1][0] == this && H.splice(f - 1, 1);
            ...
            init: function (a, b) {
                ...
                if (this.tagValCache.hasOwnProperty(a)) b = this.tagValCache.key; else {
                    if (void 0 === (b = this.tag.getAttribute(f + a)) || null === b) b = I; else if ("[" === b.substr(0, 1)) for (b = b.substr(1, b.length - 2).split(","), c = b.length; c--;) b[c] = i(b[c].replace(/(^\s*)|(\s*$)/g, "")); else if ("{" === b.substr(0, 1)) for (d = b.substr(1, b.length - 2).split(","), b = {}, c = d.length; c--;) e = d[c].split(":", 2), b[e[0].replace(/(^\s*)|(\s*$)/g, "")] = i(e[1].replace(/(^\s*)|(\s*$)/g, "")); else b = i(b);
            ...
            disabled: !1, init: function (a, b, d, e, f) {
                ...
                var a, b, d, e, g, h, i, j, k, l, m, n, o, p, q = this.options, r = "", s = [];
                ...
                for (d = b.length, o = a.length, h = 0; h < d; h++) for (n = b[h], "string" == typeof n && (n = new f(n)), e = n.fclass || "jqsfield", p = 0; p < o; p++) a[p].isNull && q.get("tooltipSkipNull") || (c.extend(a[p], {
                ...
                var d, e, f, h, i = c.get("highlightColor"), j = c.get("highlightLighten");
                if (i) return i;
            ...
            changeHighlight: function (a) {
                var b, d = this.currentRegion, e = this.target, f = this.regionShapes[d];
                ...
                var a, b, d, e, f = this.values, g = this.target, h = this.regionShapes;
                if (this.cls._super.render.call(this)) {
                    for (d = f.length; d--;) if (a = this.renderRegion(d)) if (c.isArray(a)) {
                        for (b = [], e = a.length; e--;) a[e].append(), b.push(a[e].id);
                        h[d] = b
                    } else a.append(), h[d] = a.id; else h[d] = null;
                    g.render()
                }
            }
            ...
            type: "line", init: function (a, b, c, d, e) {
                ...
                var a, b, c = this.currentRegion, d = this.target, e = this.vertices[c], f = this.options,
                    g = f.get("spotRadius"), h = f.get("highlightSpotColor"), i = f.get("highlightLineColor");
                ...
                var g = this.options.get("normalRangeMin"), h = this.options.get("normalRangeMax"),
                    i = c + b.round(d - d * ((h - this.miny) / f)), j = b.round(d * (h - g) / f);
                ...
                var a, d, e, f, g, h, i, j, k, l, m, n, o, p, r, s, t, v, w, x, y, z, A, B, C, D = this.options,
                    E = this.target, F = this.canvasWidth, G = this.canvasHeight, H = this.vertices,
                    I = D.get("spotRadius"), J = this.regionMap;
                if (u._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), A = this.xvalues, B = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    if (I && D.get("valueSpots")) for (x = D.get("valueSpots"), void 0 === x.get && (x = new q(x)), C = 0; C < s; C++) (z = x.get(B[C])) && E.drawCircle(g + b.round((A[C] - this.minx) * (F / a)), f + b.round(G - G * ((B[C] - this.miny) / d)), I, void 0, z).append();
            ...
            type: "bar", init: function (a, d, e, f, h) {
                var l, m, n, o, p, r, s, t, u, w, x, y, z, A, B, C, D, E, F, G, H, I,
                    J = parseInt(e.get("barWidth"), 10), K = parseInt(e.get("barSpacing"), 10),
                    L = e.get("chartRangeMin"), M = e.get("chartRangeMax"), N = e.get("chartRangeClip"), O = 1 / 0,
                    P = -1 / 0;
                ...
                var Q = [], R = [];
                for (r = 0, s = d.length; r < s; r++) if (B) for (C = d[r], d[r] = F = [], Q[r] = 0, o[r] = R[r] = 0, D = 0, E = C.length; D < E; D++) null !== (G = F[D] = N ? g(C[D], z, A) : C[D]) && (G > 0 && (Q[r] += G), O < 0 && P > 0 ? G < 0 ? R[r] += b.abs(G) : o[r] += G : o[r] += b.abs(G - (G < 0 ? P : O)), p.push(G)); else G = N ? g(d[r], z, A) : d[r], null !== (G = d[r] = i(G)) && p.push(G);
                ...
                var a, b, c = this.currentRegion, d = o(this.values[c]), e = [];
                ...
                var e, f, g, h, i, j, k, l, n, o, p = this.values[a], q = this.options, r = this.xaxisOffset, s = [],
                    t = this.range, u = this.stacked, v = this.target, w = a * this.totalBarWidth,
                    x = this.canvasHeightEf, y = this.yoffset;
            ...
            type: "tristate", init: function (a, b, d, e, f) {
                ...
                var c, d = this.values, e = this.options, f = this.colorMapByIndex, g = this.colorMapByValue;
            ...
            type: "discrete", init: function (a, d, e, f, g) {
                ...
                var d, e, f, h, i = this.values, j = this.options, k = this.min, l = this.max, m = this.range,
            ...
            type: "bullet", init: function (a, c, d, e, f) {
                var g, h, i;
            ...
            type: "pie", init: function (a, d, e, f, g) {
                var h, i = 0;
                if (z._super.init.call(this, a, d, e, f, g), this.shapes = {}, this.valueShapes = {}, this.values = d = c.map(d, Number), "auto" === e.get("width") && (this.width = this.height), d.length > 0) for (h = d.length; h--;) i += d[h];
                ...
                var d, e, f, g, h, i = this.target, j = this.options, k = this.radius, l = j.get("borderWidth"),
                    m = j.get("offset"), n = 2 * b.PI, o = this.values, p = this.total,
                    q = m ? 2 * b.PI * (m / 360) : 0;
                ...
                var a, c, d = this.target, e = this.values, f = this.options, g = this.radius, h = f.get("borderWidth");
            ...
            type: "box", init: function (a, b, d, e, f) {
                ...
                var a, c, d, e, f, g, i, j, k, l, m, n = this.target, o = this.values, p = o.length, q = this.options,
                    r = this.canvasWidth, s = this.canvasHeight,
                    t = void 0 === q.get("chartRangeMin") ? b.min.apply(b, o) : q.get("chartRangeMin"),
                    u = void 0 === q.get("chartRangeMax") ? b.max.apply(b, o) : q.get("chartRangeMax"), v = 0;
                if (A._super.render.call(this)) {
                    if (q.get("raw")) q.get("showOutliers") && o.length > 5 ? (c = o[0], a = o[1], e = o[2], f = o[3], g = o[4], i = o[5], j = o[6]) : (a = o[0], e = o[1], f = o[2], g = o[3], i = o[4]); else if (o.sort(function (a, b) {
                        return a - b
            ...
            _pxregex: /(\d+)(px)?\s*$/i, init: function (a, b, d) {
            ...
            init: function (b, d, e) {
                ...
                var d = c("#jqsshape" + a), e = this["_draw" + b.type].apply(this, b.args);
                d[0].outerHTML = e
            }, replaceWithShapes: function (a, b) {
                var d, e = c("#jqsshape" + a[0]), f = "", g = b.length;
