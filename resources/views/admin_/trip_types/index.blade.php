    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('admin/trip_types')}}">@lang('common.trip_types')</a></li>
            </ol>
        </nav>
...
{{--                            @if(auth()->user()->hasAnyPermission(['add_trip_types']))--}}
                                <a href="{{url('admin/trip_types/create')}}" id="info" class="btn btn-primary"><i
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/trip_types")}}/';
...
'columnDefs': [
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/trip_types/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
