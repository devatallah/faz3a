    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('admin/pages')}}">@lang('common.pages')</a></li>
            </ol>
        </nav>
...
{{--                            @if(auth()->user()->hasAnyPermission(['add_pages']))--}}
{{--
                                <a href="{{url('admin/pages/create')}}" id="info" class="btn btn-primary"><i
                                        class="fa fa-plus"></i> @lang('common.add')</a>
--}}
{{--                            @endif--}}
{{--                            @if(auth()->user()->hasAnyPermission(['delete_pages']))--}}
{{--
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/pages")}}/';
...
'columnDefs': [
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/pages/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
