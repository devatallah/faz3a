...
@section('title')
    @lang('common.edit') @lang('common.page')
@endsection
@section('css')
@endsection
@section('styles')
    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('common.edit') @lang('common.page')</li>
            </ol>
        </nav>
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>@lang('common.edit') @lang('common.page')</h4>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        <form action="{{url(app()->getLocale()."/admin/pages/$page->id")}}" id="basic-form" method="post"
                                        ...
                                        @foreach(locales() as $key => $value)
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <textarea name="content_{{$key}}" class="form-control"
                                                              id="content_{{$key}}" cols="20" rows="10"
                                                              placeholder="@lang('common.name') @lang("common.$value")"
                                                    >{{$page->getTranslation('content', $key)}}</textarea>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                        @endforeach
                                </div>
