    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('common.page')</li>
            </ol>
        </nav>
                                    ...
                                    @foreach(locales() as $key => $value)
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="name_{{$key}}"
                                                   value="{{$page->getTranslation('name', $key)}}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-10">
                                            ...
                                            <textarea disabled name="description_{{$key}}" class="form-control"
                                                      ...
                                                      placeholder="@lang('common.name') @lang("common.$value")"
                                            >{{$page->getTranslation('description', $key)}}</textarea>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                @endforeach
