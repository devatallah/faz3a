    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('common.subscription')</li>
            </ol>
        </nav>
                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>@lang('common.subscription')</h4>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        <form action="{{url(app()->getLocale()."/admin/subscriptions/$subscription->id")}}" id="basic-form" method="post"
                                    ...
                                    @foreach(locales() as $key => $value)
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="name_{{$key}}"
                                                   value="{{$subscription->getTranslation('name', $key)}}"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-10">
                                            ...
                                            <textarea disabled name="description_{{$key}}" class="form-control"
                                                      ...
                                                      placeholder="@lang('common.name') @lang("common.$value")"
                                            >{{$subscription->getTranslation('description', $key)}}</textarea>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                @endforeach
