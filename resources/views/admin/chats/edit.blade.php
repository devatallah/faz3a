...
@section('title')
    @lang('common.edit') @lang('common.chat')
@endsection
@section('css')
@endsection
@section('styles')
                ...
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{url('/admin/chats')}}">@lang('common.chats')</a></li>
                        <li class="breadcrumb-item active">@lang('common.edit') @lang('common.chat')</li>
                    </ol>
                </nav>
                <br>
                <br>
                <div class="widget-content-area br-4">
                    <div class="widget-one">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{url(app()->getLocale()."/admin/chats/$chat->id")}}" id="basic-form" method="post"
                                ...
                                <div class="form-body offset-3 col-md-7">
                                    <div class="form-row">
                                        @foreach(locales() as $key => $value)
                                            <div class="form-group col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="name_{{$key}}"
                                                       value="{{$chat->getTranslation('name', $key)}}"
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="price"
                                                   required name="price" value="{{$chat->price}}"
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="days"
                                                   required name="days" value="{{$chat->days}}"
                                    ...
                                    <a href="{{url('/admin/chats')}}" id="cancel_btn" class="btn btn-default">
                                        @lang('common.cancel')
                                    </a>
                                </div>
                            </form>
