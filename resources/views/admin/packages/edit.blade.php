...
@section('title')
    @lang('common.edit') @lang('common.package')
@endsection
@section('css')
@endsection
@section('styles')
                ...
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{url('/admin/packages')}}">@lang('common.packages')</a></li>
                        <li class="breadcrumb-item active">@lang('common.edit') @lang('common.package')</li>
                    </ol>
                </nav>
                <br>
                <br>
                <div class="widget-content-area br-4">
                    <div class="widget-one">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{url(app()->getLocale()."/admin/packages/$package->id")}}" id="basic-form" method="post"
                                ...
                                <div class="form-body offset-3 col-md-7">
                                        ...
                                        @foreach(locales() as $key => $value)
                                            <div class="form-group col-md-5">
                                                ...
                                                <input type="text" class="form-control" id="name_{{$key}}"
                                                       value="{{$package->getTranslation('name', $key)}}"
                                    ...
                                    <a href="{{url('/admin/packages')}}" id="cancel_btn" class="btn btn-default">
                                        @lang('common.cancel')
                                    </a>
                                </div>
                            </form>
