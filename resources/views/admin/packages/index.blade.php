            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/packages')}}">@lang('common.packages')</a></li>
                    </ol>
                </nav>
                <br>
                <br>
                    ...
                    <div class="widget-one">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="form-group" style="text-align: end">
                                {{--                            @if(auth()->user()->hasAnyPermission(['add_packages']))--}}
                                <a href="{{url('admin/packages/create')}}" id="info" class="btn btn-primary"><i
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/packages")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/packages/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
