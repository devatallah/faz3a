...
@section('title')
    @lang('common.add') @lang('common.package')
@endsection
@section('css')
@endsection
@section('styles')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">@lang('common.add') @lang('common.package')</li>
                    </ol>
                </nav>
                <br>
                <br>
                <div class="widget-content-area br-4">
                    <div class="widget-one">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{url(app()->getLocale().'/admin/packages')}}" id="basic-form" method="POST"
