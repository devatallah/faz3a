            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/vehicle_types')}}">@lang('common.vehicle_types')</a></li>
                    </ol>
                </nav>
                <br>
                <br>
                        ...
                        <div class="widget-content widget-content-area">
                            <form id="search_form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="s_service_id">@lang('common.services')</label>
                                        <select name="service_id" id="s_service_id">
                            ...
                            <div class="form-group" style="text-align: end">
                                {{--                            @if(auth()->user()->hasAnyPermission(['add_vehicle_types']))--}}
                                <a href="{{url('admin/vehicle_types/create')}}" id="info" class="btn btn-primary"><i
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/vehicle_types")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/vehicle_types/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
            ...
            columns: [
                ...
                {data: 'id', name: 'id'},
                {data: 'vehicle_type_name', name: 'name'},
                {data: 'services_text', name: 'name'},
