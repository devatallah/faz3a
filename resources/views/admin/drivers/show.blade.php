                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <select disabled name="gender" id="gender">
                                                        ...
                                                        <option
                                                            value="male" {{$driver->gender == 'male' ? 'selected' : ''}} >@lang('common.male')</option>
                                                        <option
                                                            value="female" {{$driver->gender == 'female' ? 'selected' : ''}} >@lang('common.female')</option>
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                {{--                                        </div>--}}
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input disabled type="text" class="form-control" id="id_no"
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input disabled type="text" class="form-control" id="plate_no"
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <select disabled name="trip_type_id" id="trip_type_id">
                                                        @foreach($trip_types as $trip_type)
                                                            <option
                                                                value="{{$trip_type->id}}" {{$trip_type->id == $driver->trip_type_id ? 'selected' : ''}}>{{$trip_type->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <select disabled name="vehicle_type_id" id="vehicle_type_id">
                                                        @foreach($vehicle_types as $vehicle_type)
                                                            <option
                                                                value="{{$vehicle_type->id}}" {{$vehicle_type->id == $driver->vehicle_type_id ? 'selected' : ''}}>{{$vehicle_type->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <select disabled name="service_ids[]" id="service_ids" multiple>
                                                        @foreach($current_services as $current_service)
                                                            <option value="{{$current_service->id}}" {{in_array($current_service->id, $driver->services->pluck('id')->toArray()) ? 'selected' : ''}}>{{$current_service->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input disabled type="date" class="form-control"
                                                           id="driver_licence_expire_date"
                                                           name="driver_licence_expire_date"
                                                           value="{{$driver->driver_licence_expire_date}}"
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input disabled type="date" class="form-control"
                                                           id="vehicle_licence_expire_date"
                                                           name="vehicle_licence_expire_date"
                                                           value="{{$driver->vehicle_licence_expire_date}}"
...
{{--
                                                    <span class="btn btn-secondary btn-file">
                                                        ...
                                                        <input disabled type="file" name="image"></span>
--}}
                                                        </div>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
...
{{--
                                                    <span class="btn btn-secondary btn-file">
                                                                ...
                                                                <span
                                                                    class="fileinput-exists"> @lang('common.select_image')</span>
                                                        <input disabled type="file" name="id_image"></span>
--}}
                                                        </div>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="fileinput fileinput-exists"
                                                        ...
                                                        <div class="fileinput-preview thumbnail"
                                                             data-trigger="fileinput"
                                                             style="width: 200px; height: 150px;">
                                                            <img src="{{$driver->driver_licence_image}}"
                                                                 alt=""/>
                                                        </div>
                                                        <div>
{{--
                                                    <span class="btn btn-secondary btn-file">
                                                                ...
                                                                <span
                                                                    class="fileinput-exists"> @lang('common.select_image')</span>
                                                        <input disabled type="file" name="driver_licence_image"></span>
--}}
                                                        </div>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="fileinput fileinput-exists"
                                                        ...
                                                        <div class="fileinput-preview thumbnail"
                                                             data-trigger="fileinput"
                                                             style="width: 200px; height: 150px;">
                                                            <img src="{{$driver->vehicle_licence_image}}"
                                                                 alt=""/>
                                                        </div>
                                                        <div>
{{--
                                                    <span class="btn btn-secondary btn-file">
                                                                ...
                                                                <span
                                                                    class="fileinput-exists"> @lang('common.select_image')</span>
                                                        <input disabled type="file" name="vehicle_licence_image"></span>
--}}
                                                        </div>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
...
{{--
                                                    <span class="btn btn-secondary btn-file">
                                                                ...
                                                                <span
                                                                    class="fileinput-exists"> @lang('common.select_image')</span>
                                                        <input disabled type="file" name="vehicle_image"></span>
--}}
                                                        </div>
                                                        <div class="invalid-feedback"></div>
                                                    </div>
    ...
    <script>
        ...
        function loadMessages() {
            (async () => {
                ...
                marker3 = new mapboxgl.Marker()
                    .setLngLat([object.attributes.lng, object.attributes.lat])
                    .setPopup(new mapboxgl.Popup().setText('{{$driver->name}}'))
                    .addTo(map);
                map.easeTo({
                    center: [object.attributes.lng, object.attributes.lat], // starting position [lng, lat]
        ...
        (async () => {
            ...
            subscription.on('update', function (obj) {
                marker3.setLngLat([obj.attributes.lng, obj.attributes.lat]);
                map.easeTo({
                    center: [obj.attributes.lng, obj.attributes.lat], // starting position [lng, lat]
