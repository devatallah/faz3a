...
{{--
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="for_passengers" id="for_passengers">
                                                ...
                                                <option value="1" {{$service->for_passengers == 1 ? 'selected' : ''}}>@lang('common.yes')</option>
                                                <option value="0" {{$service->for_passengers == 0 ? 'selected' : ''}}>@lang('common.no')</option>
                                            </select>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                        <div class="form-group col-md-5">
                                            ...
                                            <select name="for_packages" id="for_packages">
                                                <option selected value="">@lang('common.select')</option>
                                                <option value="1" {{$service->for_packages == 1 ? 'selected' : ''}}>@lang('common.yes')</option>
                                                <option value="0" {{$service->for_packages == 0 ? 'selected' : ''}}>@lang('common.no')</option>
                                            </select>
                                            <div class="invalid-feedback"></div>
                                        </div>
--}}
