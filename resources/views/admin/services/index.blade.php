                    ...
                    <div class="widget-one">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="form-group" style="text-align: end">
                                {{--                            @if(auth()->user()->hasAnyPermission(['add_services']))--}}
    ...
    <script>
        ...
        var oTable = $('#datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'id', name: 'id'},
                {data: 'service_name', name: 'name'},
                // {data: 'for_passengers_text', name: 'for_passengers'},
                // {data: 'for_packages_text', name: 'for_packages'},
