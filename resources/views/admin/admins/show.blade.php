    ...
    <div class="layout-px-spacing">
        ...
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">@lang('common.admin')</li>
            </ol>
        </nav>
                            ...
                            <div class="form-body offset-3 col-md-7">
                                    ...
                                    @foreach(locales() as $key => $value)
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="name_{{$key}}"
                                                   ...
                                                   value="{{$admin->getTranslation('name', $key)}}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        ...
                                        <textadmin disabled disabled name="note" class="form-control" id="note" cols="30" rows="3"
                                                  placeholder="@lang('common.note')">{{$admin->note}}</textadmin>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
